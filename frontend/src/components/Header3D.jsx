...
const Header3D = () => {
  ...
  const navItems = [
    ...
    { id: 'about', label: 'About', icon: Info, href: '/about-us' },
    { id: 'services', label: 'Services', icon: Briefcase, href: '/services' },
    { id: 'portfolio', label: 'Portfolio', icon: FolderOpen, href: '/all-projects' },
    { id: 'blog', label: 'Blog', icon: BookOpen, href: '/blog' },
    { id: 'contact', label: 'Contact', icon: Phone, href: '/quote' }
  ];
